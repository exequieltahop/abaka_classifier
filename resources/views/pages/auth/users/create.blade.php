            ...
            <div class="flex justify-center">
                ...
                <form action="{{ route('users.store') }}" class="p-3 w-full max-w-[900px]" method="POST">
                    ...
                    <div class="grid gap-2">
                        ...
                        <div class="mb-3">
                            <label for="username" class="font-medium text-violet-800">Usernamme</label>
                            <input type="text" name="username" id="username"
                                class="w-full border border-violet-800 p-2 text-violet-800" placeholder="Username"
                                value="{{ old('username') }}">
                            @error('username')
                                <small class="text-red-700 font-medium">{{ $message }}</small>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" name="password" id="password"
                                class="w-full border border-violet-800 p-2 text-violet-800"
                                placeholder="Password (Contains 1 uppercase, 1 lowercase, 1 number  min 8 char)">
                            @error('password')
                                <small class="text-red-700 font-medium">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="mb-3">
                            <label for="password_confirmation" class="font-medium text-violet-800">Password
                                Confirmation</label>
                            <input type="password" name="password_confirmation" id="password_confirmation"
                                class="w-full border border-violet-800 p-2 text-violet-800"
                                placeholder="Password Confirmation (Contains 1 uppercase, 1 lowercase, 1 number  min 8 char)">
