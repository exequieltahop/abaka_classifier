<x-auth-layout title="Manage Users - Update">
    <div class="container mx-auto px-3 mt-5">
        ...
        <div class="w-full shadow-xl rounded-sm border border-gray-300 mt-5">
            ...
            <div class="flex justify-center">
                ...
                {{-- form --}}
                <form action="{{ route('users.update', ['user' => urlencode($data->encrypted_id)]) }}" class="p-3 w-full max-w-[900px]" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="grid gap-2">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" id="name"
                                ...
                                placeholder="Ex. Juan Dela Cruz" value="{{ $data->name }}">
                            @error('name')
