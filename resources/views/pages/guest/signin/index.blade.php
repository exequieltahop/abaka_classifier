    ...
    <div class="container-fluid"
        ...
        <section class="container mx-auto">
            <div class="flex justify-center items-center h-screen">
                ...
                {{-- form --}}
                <form action="" id="form-signin" class="w-[90%] max-w-[550px] p-10 shadow-lg bg-white rounded-sm border border-gray-200 shadow">
                    @csrf
                    <fieldset>
                        <legend class="text-primary font-medium text-2xl mb-2 text-center">Abaca Classification System</legend>
                        ...
                        <div class="text-center">
                            <span class="text-primary">
                                Dont have an account? <a href="{{route('signup')}}" class="font-medium">sign up here</a>
                            </span>
                        </div>
                    </fieldset>
                </form>
